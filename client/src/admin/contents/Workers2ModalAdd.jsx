...
export default function Workers2ModalAdd() {
  ...
  const body = (
    <div className={classes.root}>
      ...
      <br/><br/><Button className={classes.button} variant="contained" style={{backgroundColor:"#9fd8ac" }}>직원 추가</Button>
      &nbsp;&nbsp;&nbsp;&nbsp;<Button className={classes.button} variant="contained" style={{backgroundColor:"#ea5757"}}>취소</Button>
        </Grid>
          </Paper> 
    </div>
  );
